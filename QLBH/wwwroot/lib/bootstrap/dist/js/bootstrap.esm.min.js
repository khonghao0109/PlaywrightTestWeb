...
function addHandler(e, t, i, n, s) {
  ...
  const [o, r, a] = normalizeParams(t, i, n),
    l = getEvent(e),
    c = l[a] || (l[a] = {}),
    _ = findHandler(c, r, o ? i : null);
  if (_) return void (_.oneOff = _.oneOff && s);
  const h = getUidEvent(r, t.replace(namespaceRegex, "")),
    E = o ? bootstrapDelegationHandler(e, i, n) : bootstrapHandler(e, i);
  ((E.delegationSelector = o ? i : null),
    (E.originalHandler = r),
    (E.oneOff = s),
    (E.uidEvent = h),
    (c[h] = E),
    e.addEventListener(a, E, o));
}
...
class Carousel extends BaseComponent {
  ...
  _slide(e, t) {
    const i = this._directionToOrder(e),
      ...
      _ = l ? CLASS_NAME_NEXT : CLASS_NAME_PREV,
    ...
    if (this._element.classList.contains("slide")) {
      (o.classList.add(_), reflow(o), n.classList.add(c), o.classList.add(c));
      const e = () => {
        (o.classList.remove(c, _),
          o.classList.add("active"),
          n.classList.remove("active", _, c),
          (this._isSliding = !1),
          setTimeout(E, 0));
      };
...
class Collapse extends BaseComponent {
  ...
  show() {
    ...
    if (this._config.parent) {
      const e = SelectorEngine.find(".collapse .collapse", this._config.parent);
